...
class AddEventItemView extends _abstract_view__WEBPACK_IMPORTED_MODULE_3__["default"] {
...
class EventItemEditView extends _abstract_view__WEBPACK_IMPORTED_MODULE_3__["default"] {
  constructor(tripEvent) {
    super();
  ...
  get template() {
    return createEventItemEditTemplate(_classPrivateFieldGet(this, _tripEvent));
  }
...
(0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(tripEventsListElement.element, new _view_event_add_view_js__WEBPACK_IMPORTED_MODULE_4__["default"](tripEvents[1]).element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND); // render(tripEventsListElement.element, new AddEventItemView(tripEvents[0]).element, RenderPosition.BEFOREEND);

const renderEvent = (eventListElement, event) => {
  const eventItemComponent = new _view_event_item_view_js__WEBPACK_IMPORTED_MODULE_6__["default"](event);
  const eventEditComponent = new _view_event_edit_view__WEBPACK_IMPORTED_MODULE_5__["default"](event);
